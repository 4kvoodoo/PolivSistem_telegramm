...
<a id="chapter-0"></a>
## Описание проекта
Система автополива растений станет для вас опорой. С ней вы можете покинуть свой дом на долгое время и не переживать о том что ваши любимые цветочки могут завянуть. В любом месте мира при наличие телеграмма и интернета вы сможете полить свои цветы.
Проект нацелен на максимально удобное управление при минимальном бюджете.

### Железо
* Проект сделан на основе микроконтроллера ESP8266 Wemos d1 mini (но можно использовать любую другую плату ESP8266 при условии если вы разберётель с её питанием)
* Для проекта так же потребуется погружной насос на 5 вольт и шланг к нему (при покупке шланга обратите внимание на его диаметр)
* Так же нам понадобится любой MOSFET транзистор (разные виды могут подключаться по разному). Не надо брать сильно мощьный транзистор так как даже самый сильный насос и ESP8266 сумарно потребляют меньше 5 Вт/ч
* Источник питания может быть любым главное что бы напряжение блока питания и насоса совпадали (На некоторых ESP8266 есть выходы как 5 В так и 3.3 В по этому убедитесь в правельно подобранном источнике питания или понизьте напряжение до нужного)

### Корпус
* Корпуса может не быть
* Или можно запихать его в самую маленькую коробочку
